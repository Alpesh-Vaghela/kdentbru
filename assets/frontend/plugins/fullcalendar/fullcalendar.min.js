        ...
        var l = n(2),
            ...
            c = function(t) {
                ...
                return l.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    if (f.unshift("fc-time-grid-event fc-day-grid-event-custom "+d.miscProps.type+" "+d.miscProps.service_provider, "fc-v-event"), o.isMultiDayRange(a.unzonedRange)) {
            ...
            u = function(t) {
                ...
                return o.__extends(e, t), e.prototype.renderBgRanges = function(e) {
                    ...
                    for (i = 0; i < h; i++) {
                        if (r = p[i], o = 0, a = s("<tr/>"), g.push([]), v.push([]), y.push([]), r)
                            for (l = 0; l < r.length; l++) {
                                for (u = r[l], n(u.leftCol), d = s('<td class="fc-event-container fc-event-container-custom"/>').append(u.el), u.leftCol !== u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : y[i][o] = d; o <= u.rightCol;) v[i][o] = d, g[i][o] = u, o++;
                                a.append(d)
                            }
                    ...
                    var n, i, r = this.view,
                        ...
                        h = ""; 
                    return c.unshift("fc-day-grid-event fc-day-grid-event-custom "+o.miscProps.type +" "+ a.htmlEscape(o.miscProps.service_provider)+" "), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + a.htmlEscape(n) + "</span>"), i = '<span class="fc-title">' + (a.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a style="border: 2px solid '+o.miscProps.appointmentColor +'" class="' + c.join(" ") + '"' + (o.url ? ' href="' + a.htmlEscape(o.miscProps.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? i + " " + h : h + " " + i) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer" />' : "") + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
