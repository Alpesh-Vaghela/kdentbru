...
class feature {
	...
	public function create_time_range($start, $end, $interval = '15 mins', $format = '12') {
		$startTime = strtotime($start);
	    $endTime   = strtotime($end);
	   // $returnTimeFormat = ($format == '12')?'g:i:s A':'G:i:s';
	    $returnTimeFormat = ($format == '12')?'h:i A':'H:i:s';
	    // echo date($returnTimeFormat);exit;
 ...
 */
	...
	public function date_difference ($date1timestamp, $date2timestamp) {
	    ...
	    return array('day'=>$d,'hours'=>$h, 'mins'=>$m);
	}
