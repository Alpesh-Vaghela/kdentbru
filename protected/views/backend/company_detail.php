...
<?php if (isset($_POST['update_company_detail_form_submit']))
{
   ...
   // $date_format=$_POST['dateformat'];
    ...
    $path = SERVER_ROOT.'/uploads/company/'.$company_id.'/logo';
    ...
    elseif(($logo['name']) != '')
    {
        if(file_exists(SERVER_ROOT.'/uploads/company/'.$company_id.'/logo/'.COMPANY_LOGO) && ((COMPANY_LOGO)!=''))
        {
            unlink(SERVER_ROOT.'/uploads/company/'.$company_id.'/logo/'.COMPANY_LOGO);
    ...
    if ($update)
    {
        ...
        echo "<script>
                         setTimeout(function(){
        	    		  window.location = '".$link->link("company_detail",admin,'&action_id='.$company_id)."'
        	                },3000);</script>";
    }
...
<div class="row">
 ...
 <div class="col-md-12">
  <div class="form-group">
            ...
            <div class="col-md-8">
              <?php echo $link->link('company_booking_page',frontend,'&bookingfor='.$feature->encryptIt( $company_id ));?>
            </div>
          </div>
 </div> 
 </div> --> 
<div class="row">
 ...
 <div class="col-md-12">
  <div class="form-group">
            <label class="control-label col-md-4">Your Booking Page URL</label>
            <div class="col-md-8">
              <?php echo SITE_URL.'/company_booking_page_calendar.php?bookingfor='.base64_encode($company_id.'_'.$company_details['company_name'] ).'';?>
            </div>
          </div>
            <div class="form-group">
...
<a id="Setmore_button_iframe" style="float:none" href="<?php echo SITE_URL.'/company_booking_page_calendar.php?bookingfor='.base64_encode($company_id.'_'.$company_details['company_name'] ).'';?>">
<img border="none" src="<?php echo SITE_URL.'/assets/frontend/img/appointment-book-button.png'?>" alt="Book an appointment with <?php echo $company_details['company_name'];?>" />
</a> 
            </textarea>
            </div>
          </div>
   <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" placeholder="Company Name"  name="company_name" type="text" value="<?php echo $company_details['company_name'];?>">
            </div>
          </div>
   <div class="form-group">
            <label class="control-label col-md-4">Company-Email</label>
            <div class="col-md-8">
              <input class="form-control" placeholder="Email"  name="company_email" type="text" value="<?php echo $company_details['company_email'];?>">
            </div>
   </div>
        <div class="form-group">
            <label class="control-label col-md-4">Company Logo</label>
            <div class="col-md-4">
              <?php if(file_exists(SERVER_ROOT.'/uploads/company/'.$company_id.'/logo/'.$company_details['company_logo']) && (($company_details['company_logo'])!=''))
              { ?>
                <img src="<?php echo SITE_URL.'/uploads/company/'.$company_id.'/logo/'.$company_details['company_logo'];?>" width="50%">
               <?php } else{?>
     ...
     <div class="form-group">
                  ...
                  <div class="col-md-8">
              <input class="form-control" placeholder="Phone"  name="company_phone" type="text" value="<?php echo $company_details['company_phone'];?>">
            </div>
          </div>
    <div class="form-group">
 <label class="control-label col-md-4">Company-Website</label>
     <div class="col-md-8">
                <input class="form-control" placeholder="Website" type="text" name="company_website" value="<?php echo $company_details['company_website'];?>">
              </div></div>
  <div class="form-group">
                   <label class="control-label col-md-4">Address</label>
                  <div class="col-md-8">
              <textarea class="form-control" placeholder="Address" name="company_address"><?php echo html_entity_decode($company_details['company_address']);?>
              </textarea>
            </div>
          </div>
          ...
          <div class="form-group">
                   <label class="control-label col-md-4"></label>
                  <div class="col-md-3">
              <input class="form-control" placeholder="state" name="company_state" type="text" value="<?php echo $company_details['company_state'];?>">
            </div>
              <div class="col-md-3">
             <input class="form-control" placeholder="city" name="company_city" type="text" value="<?php echo $company_details['company_city'];?>">
            </div>
              <div class="col-md-2">
              <input class="form-control" placeholder="Zip"  name="company_zip" type="text" value="<?php echo $company_details['company_zip'];?>">
            </div>
          </div>
    ...
    <label class="control-label col-md-4">Currency symbol</label>
           ...
           <!--    <div class="form-group">
              <input type="hidden" name="date_format" id="date_format" value="<?php echo $company_details['date_format'];?>">
             ...
             <select class="form-control" name="dateformat" id="dateformat">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-8">
              <textarea class="form-control" placeholder="Company Description" name="company_description"><?php echo html_entity_decode($company_details['company_description']);?>
              </textarea>
            </div>
          </div>
                                            ...
                                            if (is_array($working_day)){
                                                ...
                                                <tr>
                                                   ...
                                                   <option <?php if ($on_off=="off"){echo "selected";}?> value="off">Off</option>
                                                    ...
                                                    <td >
                                                        <input min="08:00:00" max="20:00:00" class="form-control"  <?php if ($on_off=="off"){echo "readonly=''";}?> type="time" name="starttime[]" value="<?php echo $starttime;?>" required="">
                                                         
                                                   </td>
                                                      <td >
                                                       
                                                        <input min="08:00:00" max="20:00:00" class="form-control border-danger"  <?php if ($on_off=="off"){echo "readonly=''";}?> type="time" name="endtime[]" value="<?php echo $endtime;?>" required="">
                                                    </td>
                                                </tr>
