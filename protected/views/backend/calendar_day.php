                                                        ...
                                                        <?php if ($p_apponiments['appointment_time'] != "") {
                                                            ...
                                                            <?php if (in_array($p_apponiments['id'], $testing_array)) {
                                                                ...
                                                                <div class="alert alert-<?php echo $services_color; ?>">
                                                                    <strong><?php echo date('h:i A', strtotime($p_apponiments['appointment_time'])); ?></strong>

                                                                    <?php echo ucfirst($cfirst_name . " " . $clast_name); ?>
                                                                    <br>
                                                                    <?php echo ucfirst($service_name); ?>
                                                                    . <?php echo $p_apponiments['service_time'] + $p_apponiments['service_buffer_time'] ?>
                                                                    min
                                                                    . <?php echo CURRENCY . "" . $p_apponiments['service_cost'];
