    ...
    <div class="row">
            ...
            <div class="panel">
                ...
                <div class="panel-heading ui-sortable-handle">
                    <h3 class="panel-title">
                        ...
                        $sql2 = "SELECT COUNT(*) FROM `appointments` WHERE `company_id`='$comid' and `appointment_date` >= CURDATE() AND `status` != 'deleted'";
                        $appointment_count = $db->run($sql2)->fetchColumn();

                        $sql = "SELECT SUM(service_cost) FROM `appointments` WHERE `company_id`= '$comid' and `appointment_date` >= CURDATE() AND `status` != 'deleted'";
                        ...
                        <div class="nano has-scrollbar" style="height:380px">
                            <div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                                ...
                                <table class="table table-hover table-vcenter">
                                    ...
                                    $appointments = $db->run("SELECT * FROM `appointments` WHERE `company_id`= '$comid' and `appointment_date` >= CURDATE() AND `status` != 'deleted' ORDER BY id DESC")->fetchAll();
                                        ...
                                        foreach ($appointments as $appoint) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else if ($appoint['status'] == "deleted") { ?>
        ...
        <div class="col-md-5">
            <div class="panel">
                ...
                <!--Horizontal Form-->
                <!--===================================================-->
                <form id="add_appointment_form_quick" method="post" class="form-horizontal" action=""
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="form-control" name="customer_id" id="loadnewcus">
                                            ...
                                            if (is_array($allcustomers)) {
                                                foreach ($allcustomers as $cus) {
                                                    ...
                                                    } ?> value="<?php echo $cus['id'] ?>"><?php echo $cus['first_name'] . " " . $cus['last_name']; ?></option>
                                                <?php }
                                            } ?>
                                    ...
                                    <div class="col-md-1">
                                        <button type="button" class="btn btn-custom pull-right" data-toggle="modal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="service_provider"
                                            ...
                                            $provider = $db->run("SELECT * FROM `users` WHERE `user_type`= 'staff' AND `visibility_status`='active' AND `company_id`='".CURRENT_LOGIN_COMPANY_ID."' " . $mul_doctor_condition." ORDER BY user_id DESC")->fetchAll();
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control datepicker" type="text" name="appointment_date"
                                               value="<?php echo date('Y-m-d'); ?>" id="get_date_calender">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="private">
                                            <option <?php if ($_POST['private'] == "no") {
                                                echo "selected";
                                            }; ?> value="no">BLU
                                            </option>
                                            <option <?php if ($_POST['private'] == "yes") {
                                                echo "selected";
                                            }; ?> value="yes">ROSSO
                                            </option>
                                        </select>
                    ...
                    <div class="panel-footer text-center">
                        ...
                        <button class="btn btn-custom" name="add_time_form_submit" type="submit"><i
