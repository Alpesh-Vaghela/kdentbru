...
//facebook
if (FACEBOOK_API_ID!=NULL && FACEBOOK_API_SECRET!=NULL){
 ...
 <div id="container" class="cls-container">  
  ...
  <div class="lock-wrapper">
    ...
    <div class="panel lock-box">
      ...
      <h4> Gestione Studio Abate Brugiatelli</h4>
        ...
        <form action="<?php $_SERVER['PHP_SELF'];?>" class="form-inline" method="post">
          <div class="form-group col-md-12 col-sm-12 col-xs-12">
            <div class="text-left">
              ...
              <input name="email" type="email" placeholder="Inserisci e-mail" class="form-control" required />
            </div>
            <div class="text-left">
            ...
            <div class="pull-left pad-btm">
              <label class="form-checkbox form-icon form-text">
                <input type="checkbox" name="cookie_set" value="true" checked=""> Ricordami
              </label>
            </div> 
                        <!--     	<div class="pull-right pad-btm">
                          ...
                          <button type="submit" value="Log in" name="submit_login" class="btn btn-block btn-success">
                            <i class="fa  fa-sign-in fa-lg"></i>  ENTRA
                          </button>
                          <br>
<!--<?php if (GOOGLE_CLIENT_ID!=NULL && GOOGLE_CLIENT_SECRET!=NULL){?>                              
<a class='btn btn-danger login' href='javascript:void(0);'><i class="fa  fa-google fa-lg"></i> Google Login</a>
<?php }?>
<?php if (FACEBOOK_API_ID!=NULL && FACEBOOK_API_SECRET!=NULL){?>
