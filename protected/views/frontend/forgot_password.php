...
<body>
     ...
     <?php }?>
                ...
                <div class="registration">  <a href="<?php echo $link->link('login',user);?>"> <span class="text-primary"><i class="fa  fa-arrow-circle-o-left fa-lg"></i> Back to Login </span> </a> </div>
            </div>
        </div>
        <!--===================================================--> 
        <!-- END OF CONTAINER -->
